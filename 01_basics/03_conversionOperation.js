...
/*
  let x = 5
  Type      Meaning                  Example Output   final 
  prefix    Change first,use later    ++x      6      6
  postfix   Use first,change later    x++      5      6
  prefix    Change first, use later   --x      4      4
  postfix   Use first, change later   x--      5      4
*/
